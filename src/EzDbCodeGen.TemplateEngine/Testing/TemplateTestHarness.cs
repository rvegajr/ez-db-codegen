...
public class TemplateTestHarness
{
    ...
    private readonly ILogger<TemplateTestHarness>? _logger;
    ...
    public TemplateTestHarness(
        ...
        ILogger<TemplateTestHarness>? logger = null)
    {
        ...
        TemplateTestOptions options)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(options.TargetTable))
            {
                ...
                try
                {
                    string output = await _templateProcessor.ProcessTemplateFileAsync(templatePath, tableModel);
            ...
            else if (!string.IsNullOrEmpty(options.TargetView))
            {
                ...
                try
                {
                    string output = await _templateProcessor.ProcessTemplateFileAsync(templatePath, viewModel);
                    result.Output = output;
                }
                catch (Exception ex)
                {
            ...
            else
            {
                try
                {
                    string output = await _templateProcessor.ProcessTemplateFileAsync(templatePath, model);
                    result.Output = output;
                }
                catch (Exception ex)
                {
